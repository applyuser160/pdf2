...
impl TestFixture {
    fn new() -> Self {
        ...
        TestFixture { input_path, output_path }
    }
    ...
    fn create_dummy_pdf(&self) {
        ...
        doc.trailer.set("ID", vec![Object::string_literal(id1.to_vec()), Object::string_literal(id2.to_vec())]);
...
fn test_encrypt_pdf_with_correct_password() {
    ...
    // Act
    let result = encrypt_pdf(fixture.input_path.clone(), fixture.output_path.clone(), user_password.clone(), None);
